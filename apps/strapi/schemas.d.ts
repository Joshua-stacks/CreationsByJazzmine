...
export interface ApiProductProduct extends CollectionTypeSchema {
  ...
  attributes: {
    ...
    options: ComponentAttribute<'options.options'> &
      SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface OptionsOptions extends ComponentSchema {
  info: {
    displayName: 'options';
    icon: 'dog';
    description: '';
  ...
  attributes: {
    theme: EnumerationAttribute<
      ['mermaid', 'construction', 'unicorn', 'dinosaur', 'custom']
    >;
    ledlight: BooleanAttribute;
    shirts: BooleanAttribute;
    balloons: BooleanAttribute;
